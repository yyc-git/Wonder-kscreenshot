...
export default function textBT (me) {
    let textBT = window.wonder_containerDocument.createElement('span')
    textBT.id = 'kssTextBT'
    textBT.className = 'kssToolbarItemBT'
    textBT.title = '字体工具'

    let textImg = window.wonder_containerDocument.createElement('img')
    ...
    textBT.addEventListener('click', function () {
        ...
        if (!me.textClickEvent) {
            ...
            function textClickEvent (e) {
                ...
                let textarea = window.wonder_containerDocument.createElement('div')
